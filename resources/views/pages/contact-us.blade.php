        ...
        <div class="text-[#25464b] container flex flex-col gap-20 pt-20 mx-auto text-center px-3">
            ...
            <div class="grid justify-between grid-cols-1 space-y-10 xl:grid-cols-3">
                ...
                <div class="flex flex-col items-center gap-3">
                    ...
                    <span class="text-lg font-bold xl:text-2xl">Location</span>
                    <span class="text-sm xl:text-xl text-black/70">B13L10 Jasmine Heather St. Lavistamonte 2 Subd. Matina
                        Balusong,
                        Davao City</span>
                </div>
                <div class="flex flex-col items-center gap-3">
                    ...
                    <span class="text-lg font-bold xl:text-2xl">Email Address</span>
                    <span class="text-sm xl:text-xl text-black/70">listinhere@gmail.com</span>
                </div>
            </div>
        </div>

        <div class="grid grid-cols-1 mt-20 bg-white xl:grid-cols-2">
            <div class="max-w-4xl px-4 py-12 mx-auto">
                <!-- Title -->
                <h2 class="text-2xl xl:text-4xl font-bold text-[#25464b]">Get In Touch</h2>

                <p class="max-w-2xl mt-3 text-sm leading-relaxed text-gray-600 xl:text-base">
                ...
                <form class="mt-10 space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <!-- Full Name -->
                        <div>
                            <label class="block mb-1 text-sm font-semibold text-gray-700 xl:text-base">Full Name</label>
                            <input type="text"
                        ...
                        <!-- Email -->
                        <div>
                            <label class="block mb-1 text-sm font-semibold text-gray-700 xl:text-base">Email Address</label>
                            <input type="email"
                                class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-teal-500"
                    ...
                    <!-- Subject -->
                    <div>
                        <label class="block mb-1 text-sm font-semibold text-gray-700 xl:text-base">Subject</label>
                    ...
                    <!-- Message -->
                    <div>
                        <label class="block mb-1 text-sm font-semibold text-gray-700 xl:text-base">Message</label>
                    ...
                    <!-- Submit Button -->
                    <button type="submit"
                        class="px-8 py-3 font-medium text-sm xl:text-base text-black rounded-lg shadow bg-gradient-to-b from-[#f6e887] to-[#feb101] hover:opacity-90">
                        Submit Message
                    </button>
                </form>
            </div>
            <div class="w-auto h-[50vh] xl:h-full">
                <iframe
