...
@section('content')
    <div class="pb-36 bg-[#f5f5f5] overflow-x-hidden">
        ...
        <div class="container grid grid-cols-1 gap-20 px-3 py-20 mx-auto xl:grid-cols-2">
            <div class="flex flex-col gap-7" data-aos="fade-right">
                ...
                <div class="grid grid-cols-1 gap-5 xl:grid-cols-2">
                    <div class="relative flex flex-col gap-2 px-5 py-3 overflow-hidden bg-white rounded-lg h-fit">
            ...
            <div class="flex flex-col gap-10 text-[#25464b] w-full" data-aos="fade-up" data-aos-delay="500">
                ...
                <div class="grid grid-cols-1 gap-8 2xl:grid-cols-3">
                    ...
                    <div class="flex flex-col col-span-2 px-3 text-center 2xl:text-start gap-7">
                        ...
                        <div class="flex flex-col gap-2">
                            <span class="text-xl font-bold xl:text-3xl">Our Vision</span>
                            <span class="text-sm leading-relaxed xl:text-base">To be the leading name in premium real estate
                                where smart
        ...
        <div class="container py-20 mx-auto">
            <div class="grid grid-cols-1 gap-10 px-3 xl:grid-cols-2">
                <div class="flex text-[#25464b] flex-col gap-5 items-center xl:self-start justify-center w-auto xl:sticky lg:top-[10rem] lg:items-start lg:justify-start lg:w-full lg:h-fit"
                    ...
                    <span class="text-sm leading-relaxed text-center xl:text-base xl:text-start">
                ...
                <div class="grid grid-cols-1 text-[#25464b] lg:grid-cols-2 gap-5" data-aos="fade-left">
                    <div class="flex flex-col items-center justify-center gap-4 p-5 text-center bg-white rounded-xl">
                        ...
                        <span class="text-2xl font-bold xl:text-4xl">Integrity</span>
                        <span class="text-sm leading-relaxed xl:text-base">
                    ...
                    <div class="flex flex-col items-center justify-center gap-4 p-5 text-center bg-white rounded-xl">
                        ...
                        <span class="text-2xl font-bold xl:text-4xl">Commitment</span>
                        <span class="text-sm leading-relaxed xl:text-base">
                    ...
                    <div class="flex flex-col items-center justify-center gap-4 p-5 text-center bg-white rounded-xl">
                        ...
                        <span class="text-2xl font-bold xl:text-4xl">Excellence</span>
                        <span class="text-sm leading-relaxed xl:text-base">
                    ...
                    <div class="flex flex-col items-center justify-center gap-4 p-5 text-center bg-white rounded-xl">
                        ...
                        <span class="text-2xl font-bold xl:text-4xl">Innovation</span>
                        <span class="text-sm leading-relaxed xl:text-base">
                    ...
                    <div class="flex flex-col items-center justify-center gap-4 p-5 text-center bg-white rounded-xl">
                        ...
                        <span class="text-2xl font-bold xl:text-4xl">Customer Focus</span>
                        <span class="text-sm leading-relaxed xl:text-base">
                    ...
                    <div class="flex flex-col items-center justify-center gap-4 p-5 text-center bg-white rounded-xl">
                        ...
                        <span class="text-2xl font-bold xl:text-4xl">Collaboration</span>
                        <span class="text-sm leading-relaxed xl:text-base">
